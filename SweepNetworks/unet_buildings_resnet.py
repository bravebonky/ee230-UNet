...
def get_unet0():
    ...
    skip1 =  Convolution2D(6, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(inputs)
    ...
    skip2 = Convolution2D(12, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(pool1)
    ...
    skip3 = Convolution2D(24, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(pool2)
    ...
    skip4 = Convolution2D(48, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(pool3)
    ...
    skip5 = Convolution2D(96, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(pool4)
    ...
    skip6 = Convolution2D(48, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(up6)
    ...
    skip7 = Convolution2D(24, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(up7)
    ...
    skip8 = Convolution2D(12, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(up8)
    ...
    skip9 = Convolution2D(6, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(up9)
...
if __name__ == '__main__':
    ...
    suffix = 'buildings_3_resnet'+"{batch}_{epoch}".format(batch=batch_size,epoch=nb_epoch)
