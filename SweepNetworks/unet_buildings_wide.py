...
def get_unet0():
    ...
    #conv5 = Convolution2D(512, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(pool4)
    #conv5 = BatchNormalization(mode=0, axis=1)(conv5)
    #conv5 = keras.layers.advanced_activations.ELU()(conv5)
    #conv5 = Convolution2D(512, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(conv5)
    #conv5 = BatchNormalization(mode=0, axis=1)(conv5)
    #conv5 = keras.layers.advanced_activations.ELU()(conv5)

    #up6 = merge([UpSampling2D(size=(2, 2),dim_ordering='th')(conv5), conv4], mode='concat', concat_axis=1)
    #conv6 = Convolution2D(128, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(up6)
    #conv6 = BatchNormalization(mode=0, axis=1)(conv6)
    #conv6 = keras.layers.advanced_activations.ELU()(conv6)
    #conv6 = Convolution2D(128, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(conv6)
    #conv6 = BatchNormalization(mode=0, axis=1)(conv6)
    #conv6 = keras.layers.advanced_activations.ELU()(conv6)
    ...
    up8 = merge([UpSampling2D(size=(2, 2),dim_ordering='th')(conv3), conv2], mode='concat', concat_axis=1)
...
if __name__ == '__main__':
    ...
    suffix = 'buildings_3_wide'+"{batch}_{epoch}".format(batch=batch_size,epoch=nb_epoch)
    print("meow "+suffix)
