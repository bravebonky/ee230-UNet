...
def get_unet0():
    ...
    skip1 =  Convolution2D(32, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(inputs)
    conv1 = Convolution2D(32, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(inputs)
    conv1 = BatchNormalization(mode=0, axis=1)(conv1)
    conv1 = keras.layers.advanced_activations.ELU()(conv1)
    conv1 = Convolution2D(32, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(conv1)
    conv1 = BatchNormalization(mode=0, axis=1)(conv1)
    conv1 = keras.layers.Add()([conv1,skip1])
    conv1 = keras.layers.advanced_activations.ELU()(conv1)
    pool1 = MaxPooling2D(pool_size=(2, 2),dim_ordering='th')(conv1)

    skip2 = Convolution2D(64, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(pool1)
    conv2 = Convolution2D(64, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(pool1)
    conv2 = BatchNormalization(mode=0, axis=1)(conv2)
    conv2 = keras.layers.advanced_activations.ELU()(conv2)
    conv2 = Convolution2D(64, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(conv2)
    conv2 = BatchNormalization(mode=0, axis=1)(conv2)
    conv2 = keras.layers.Add()([conv2,skip2])
    conv2 = keras.layers.advanced_activations.ELU()(conv2)
    pool2 = MaxPooling2D(pool_size=(2, 2),dim_ordering='th')(conv2)

    skip3 = Convolution2D(128, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(pool2)
    conv3 = Convolution2D(128, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(pool2)
    conv3 = BatchNormalization(mode=0, axis=1)(conv3)
    conv3 = keras.layers.advanced_activations.ELU()(conv3)
    conv3 = Convolution2D(128, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(conv3)
    conv3 = BatchNormalization(mode=0, axis=1)(conv3)
    conv3 = keras.layers.Add()([conv3,skip3])
    conv3 = keras.layers.advanced_activations.ELU()(conv3)
    pool3 = MaxPooling2D(pool_size=(2, 2),dim_ordering='th')(conv3)

    skip4 = Convolution2D(256, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(pool3)
    conv4 = Convolution2D(256, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(pool3)
    conv4 = BatchNormalization(mode=0, axis=1)(conv4)
    conv4 = keras.layers.advanced_activations.ELU()(conv4)
    conv4 = Convolution2D(256, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(conv4)
    conv4 = BatchNormalization(mode=0, axis=1)(conv4)
    ...
    up7 = merge([UpSampling2D(size=(2, 2),dim_ordering='th')(conv4), conv3], mode='concat', concat_axis=1)
    skip7 = Convolution2D(128, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(up7)
    conv7 = Convolution2D(128, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(up7)
    conv7 = BatchNormalization(mode=0, axis=1)(conv7)
    conv7 = keras.layers.advanced_activations.ELU()(conv7)
    conv7 = Convolution2D(128, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(conv7)
    conv7 = BatchNormalization(mode=0, axis=1)(conv7)
    conv7 = keras.layers.Add()([conv7,skip7])
    conv7 = keras.layers.advanced_activations.ELU()(conv7)

    up8 = merge([UpSampling2D(size=(2, 2),dim_ordering='th')(conv7), conv2], mode='concat', concat_axis=1)
    skip8 = Convolution2D(64, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(up8)
    conv8 = Convolution2D(64, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(up8)
    conv8 = BatchNormalization(mode=0, axis=1)(conv8)
    conv8 = keras.layers.advanced_activations.ELU()(conv8)
    conv8 = Convolution2D(64, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(conv8)
    conv8 = BatchNormalization(mode=0, axis=1)(conv8)
    conv8 = keras.layers.Add()([conv8,skip8])
    conv8 = keras.layers.advanced_activations.ELU()(conv8)

    up9 = merge([UpSampling2D(size=(2, 2),dim_ordering='th')(conv8), conv1], mode='concat', concat_axis=1)
    skip9 = Convolution2D(32, 1, 1, border_mode='same', init='he_uniform',dim_ordering='th')(up9)
    conv9 = Convolution2D(32, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(up9)
    conv9 = BatchNormalization(mode=0, axis=1)(conv9)
    conv9 = keras.layers.advanced_activations.ELU()(conv9)
    conv9 = Convolution2D(32, 3, 3, border_mode='same', init='he_uniform',dim_ordering='th')(conv9)
...
if __name__ == '__main__':
    ...
    suffix = 'buildings_3_resnet_wider'+"{batch}_{epoch}".format(batch=batch_size,epoch=nb_epoch)
